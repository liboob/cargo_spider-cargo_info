...
def main():
    url = 'https://crates.io/api/v1/crates?page=1&per_page=100&sort=recent-updates'
    ...
    if response.status_code == 200:
        ...
        with open('update_package.txt', 'r', encoding='utf-8') as f:
        ...
        for package in url_data[::]:
            if package in new_packages:
                ...
                with open('update_package.txt', 'a', encoding='utf-8') as f:
                    f.write(package + '\n')
