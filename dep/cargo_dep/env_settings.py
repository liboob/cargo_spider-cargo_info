...
# lj_id生成数据库
MYSQL_17_HOST = os.getenv('MYSQL_17_HOST', 'rm-2zed9e3s0xa04m7q3.mysql.rds.aliyuncs.com')
MYSQL_17_PORT = int(os.getenv('MYSQL_17_PORT', 3306))
MYSQL_17_USER = os.getenv('MYSQL_17_USER', 'fosseye')
MYSQL_17_PASSWORD = os.getenv('MYSQL_17_PASSWORD', '')
MYSQL_17_DB = os.getenv('MYSQL_17_DB', 'lj_id')
MYSQL_17_CHARSET = os.getenv('MYSQL_17_CHARSET', 'utf8')

# mysql数据存储数据库
MYSQL_HOST = os.getenv('MYSQL_HOST', 'rm-2zed9e3s0xa04m7q3.mysql.rds.aliyuncs.com')
