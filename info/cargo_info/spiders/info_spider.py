...
class InfoSpiderSpider(RabbitSpider):
    ...
    queue_name = 'cargo_info_add_queue'
    items_key = 'cargo_dep_add_queue'
    client = pymongo.MongoClient(MONGO_CLIENT)
    # client = pymongo.MongoClient(host="127.0.0.1",port=27017,username='root',password='123456')
    db = client['Cargo']
...
if __name__ == '__main__':
    os.system("scrapy crawl info_spider")
